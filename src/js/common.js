...
$(document).on(
  "click",
  ".registration-container .steps-block span.close",
  function () {
    $(".steps-block").fadeOut();
  }
);
...
$("body").on("click", "nav.tab-pills div.tabs>ul.lst-tabs>li>a", function (e) {
  if (!$(this).hasClass("tab-selected")) {
    ...
    $(this)
      .closest("nav.tab-pills")
      .find("div.tabs-container")
      .children("div.tab-content1")
      .removeClass("tc-showing");
...
$(document).on(
  "click",
  ".right-main-column , .compact .global-nav .nav-items .lst-nav-items li .mysubnavigation-items .lst-subnavigation > li > a",
  function () {
    $(
      ".compact .global-nav .nav-items .lst-nav-items li .mysubnavigation-items "
    ).slideUp();
    $(".compact .global-nav .nav-items .lst-nav-items li a").removeClass(
      "active"
    );
  }
);
...
$("body").on("click", ".header-items .lst-header-items li a img", function () {
  if ($(this).hasClass("fullScreen")) {
    openFullscreen();
    $(".header-items .lst-header-items li a img.fullScreen").css(
      "display",
      "none"
    );
    $(".header-items .lst-header-items li a img.smallScreen").css(
      "display",
      "inline-block"
    );
  } else {
...
$("body").on(
  "click",
  ".global-nav div.nav-items ul.lst-nav-items li a",
  function (e) {
    if ($(this).hasClass("active")) {
      $(this).parent().find(".active").removeClass("active");
      $(this).parent().find(".mysubnavigation-items").slideUp();
...
$("body").on(
  "click",
  "nav.global-nav .btn-closenav, div.nav-overlay, ul.lst-nav-items>li, btn-closeglnav",
  function (e) {
    //console.log(this.id);
    if ($(this).hasClass("drilldown") || $(this).hasClass("fingerprint"))
      return;
...
$("body").on(
  "click",
  ".global-nav div.nav-items ul.lst-nav-items3 li a",
  function (e) {
    e.stopPropagation();
    if ($(this).hasClass("active")) {
      $(this).parent().find(".active").removeClass("active");
...
$("body").on(
  "click",
  "nav.global-nav .btn-closenav, div.nav-overlay, ul.lst-nav-items3>li",
  function (e) {
    e.stopPropagation();
    $("nav.global-nav").removeClass("nav-showing");
...
function switchOptionsInit() {
  $("body").on(
    "click",
    "div.ux-switch-tabs div.ux-switch>.lst-ux-switch>li>a",
    function () {
      if (!$(this).hasClass("switch-selected")) {
        var switchIndex = $(this).closest("ul.lst-ux-switch li").index();
        $(this)
          .closest("div.ux-switch-tabs")
          .find("div.ux-switch-container div.ux-switch-content")
          .removeClass("content-showing");
        $(this)
          .closest("div.ux-switch-tabs")
          .find(".lst-ux-switch>li>a")
          .removeClass("switch-selected");
        $(this).addClass("switch-selected");
        $(this)
          .closest("div.ux-switch-tabs")
          .find("div.ux-switch-container")
          .children("div.ux-switch-content")
          .eq(switchIndex)
          .addClass("content-showing");
      }
    }
  );
}
...
function fixMapHeight() {
  ...
  $("div.map-controller").height(
    windowHeight - (headerHeight + tabsHeight + 70)
  );
}
...
$(document).on(
  "change",
  ".ux-component2  label.toggle input[type=checkbox]",
  function () {
    if ($(this).prop("checked")) {
      $(this)
        .parents(".drp-box")
        .find(".entered-data")
        .addClass("showing-balance");
    } else {
      $(this)
        .parents(".drp-box")
        .find(".entered-data")
        .removeClass("showing-balance");
    }
  }
);
stickFooter();
...
function spendDoughnut(label, data) {
  ...
  document.getElementById("legendSpend").innerHTML =
    mySpendDoughnut.generateLegend();
}
...
function spendBarGraph() {
  ...
  var densityData = {
    label: false,
    data: [
      150, 400, 300, 250, 100, 150, 400, 300, 250, 100, 150, 400, 300, 250, 100,
      150, 400, 300, 250, 100,
    ],
    backgroundColor: [
      "#673AB7",
...
function numericKeypad(pinLength) {
  ...
  $("body").on(
    "keypress",
    "div.mpin-digits input[type=password]",
    function (e) {
  ...
  $("div.btn-mpin-numbers button.btn-mpin-number").click(function (e) {
    if (mPINEntering.length < pinLength) {
      ...
      $("div.mpin-dots-line div.mpin-dot-" + mPINEntering.length).addClass(
        "dot-filled"
      );
    }
    /* else {
  ...
  $("div.mpin-dots-line button.btn-mpin-fill.btn-mpin-clear").click(function (
    e
  ) {
    //console.log("inside");
    if (mPINEntering.length != 0) {
      //alert('ALL CLEARED');
      $("div.mpin-dots-line div.mpin-dot-" + mPINEntering.length).removeClass(
        "dot-filled"
      );
      mPINEntering.pop();
    }
...
$(document).click(function (e) {
  if (!window.hasOwnProperty("cordova")) {
    ...
    if (e.target.id == "pwdKeyboard" || e.target.id == "pwd_keyboard") {
      ...
      e.target.id == "userName_keyboard" ||
      $(event.target).hasClass("ui-keyboard-keyset") ||
      e.target.id == "pwd_keyboard"
    ) {
...
function mandate() {
  ...
  $(document).on(
    "change",
    '.toggle-col.yes  input[type="checkbox"]',
    function () {
      //console.log('Its working')
      // if($(this).prop("checked")){
...
function activeGlobalUpi() {
  $(document).on(
    "change",
    '.toggle-col.disable1  input[type="checkbox"]',
    function () {
      $('input[name="startDate"]')
        .parent("div.ux-input.ux-common")
        .addClass("ux-disabled");
...
function myProfile() {
  ...
  $(document).on(
    "change",
    '.toggle-col.disable  input[type="checkbox"]',
    function () {
      if ($(this).prop("checked")) {
        $(this)
          .parents("li")
          .find("div.qr-container div.qr-img")
          .addClass("disable");
        $(this)
          .parents("li")
          .find("div.qr-container div.lock-img")
          .removeClass("disable");
  ...
  $(document).on(
    "change",
    '.toggle-col.dynamic  input[type="checkbox"]',
    function () {
      if ($(this).prop("checked")) {
...
function toastLiveMessage() {
  $("button.register-btn , button.new-account-btn").click(function () {
    ...
    showToast(
      "Currently we are Live with UPI Only, Please select UPI icon to register for UPI",
      "success",
      true
    );
  });
...
function searchContactList() {
  $(document).on(
    "change",
    '.toggle-col3.syncContact  input[type="checkbox"]',
    function () {
      if ($(this).prop("checked")) {
...
function showToastSearchContactList(
  messageText,
  messageType,
  autoDismiss,
  dismissDuration
...
$("body").on(
  "click",
  ".header-items .lst-header-items li a.item-notification",
  function (e) {
...
$("body").on(
  "click",
  "aside.notification-panel .notp-header a.btn-closenoty, div.notpanel-overlay",
  function (e) {
    $(".header-items .lst-header-items li a.item-notification").removeClass(
      "noty-active"
    );
...
function lienEnquiryModal() {
  $("body").on(
    "click",
    ".flex-container .full-info .ac-info span.link-text a.link-lien",
    function () {
...
function InitVPAUI() {
  ...
  $("body").on(
    "click",
    "div.send-input .placeholder , div.send-input .sendDisplay1 ",
    function (e) {
      var windowSize = $(window).width();
      if (windowSize >= 768) {
  ...
  $("body").on(
    "click",
    "div#upiInput .placeholder , div#upiInput .sendDisplay1 ",
    function (e) {
      var windowSize = $(window).width();
      if (windowSize >= 768) {
  ...
  $("body").on("click", ".ux-selection2 input[type=radio]", function () {
    ...
    if ($(this).attr("checked") !== "checked") {
      ...
      $(this)
        .parents()
        .siblings()
        .find(".ux-selection2 input[type=radio]")
        .removeAttr("checked", "");
